...
{
    public partial class frmAppointmentDoctor : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        public DataTable dtMedicalDetail = new DataTable();
        
        public frmAppointmentDoctor()
        {
            InitializeComponent();
        ...
        private void schedulerControl1_EditAppointmentFormShowing(object sender, AppointmentFormEventArgs e)
        {
            ...
            Ps.Clinic.Entry.CustomAppointmentForm form = new Ps.Clinic.Entry.CustomAppointmentForm(scheduler, e.Appointment, e.OpenRecurrenceForm);
            try
            {
