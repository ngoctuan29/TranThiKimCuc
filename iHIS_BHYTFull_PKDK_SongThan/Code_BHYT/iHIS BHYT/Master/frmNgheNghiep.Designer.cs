namespace Ps.Clinic.Master
{
    partial class frmNgheNghiep
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.col_CareerCode = new DevExpress.XtraGrid.Columns.GridColumn();
            ...
            this.gridView_List.NewItemRowText = "Thêm mới nghề nghiệp.";
            ...
            // col_CareerCode
            // 
            this.col_CareerCode.AppearanceCell.Options.UseTextOptions = true;
            this.col_CareerCode.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
            this.col_CareerCode.AppearanceHeader.Options.UseTextOptions = true;
            this.col_CareerCode.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
            this.col_CareerCode.Caption = "Mã";
            this.col_CareerCode.FieldName = "CareerCode";
            this.col_CareerCode.Name = "col_CareerCode";
            this.col_CareerCode.OptionsColumn.AllowEdit = false;
            this.col_CareerCode.OptionsColumn.AllowSize = false;
            this.col_CareerCode.Summary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {
            new DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Count, "CareerCode", "Count: {0:#,#}")});
            this.col_CareerCode.Visible = true;
            this.col_CareerCode.VisibleIndex = 0;
            this.col_CareerCode.Width = 84;
            // 
            // col_CareerName
            // 
            this.col_CareerName.Caption = "Tên nghề nghiệp";
            this.col_CareerName.FieldName = "CareerName";
            this.col_CareerName.Name = "col_CareerName";
            this.col_CareerName.Visible = true;
            this.col_CareerName.VisibleIndex = 1;
            this.col_CareerName.Width = 922;
            // 
            // panelControl1
            // 
        ...
        private DevExpress.XtraGrid.Columns.GridColumn col_CareerCode;
