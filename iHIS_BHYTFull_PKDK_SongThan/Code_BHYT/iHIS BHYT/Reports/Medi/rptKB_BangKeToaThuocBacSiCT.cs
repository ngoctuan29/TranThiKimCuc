...
{
    public partial class rpt_KB_BangKeToaThuocBacSiCT : DevExpress.XtraReports.UI.XtraReport
    {
        //private Int32 runNumber = 0;
        public rpt_KB_BangKeToaThuocBacSiCT()
        {
            InitializeComponent();
        }
        ...
        private void rpt_KB_BangKeToaThuocBacSiCT_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
