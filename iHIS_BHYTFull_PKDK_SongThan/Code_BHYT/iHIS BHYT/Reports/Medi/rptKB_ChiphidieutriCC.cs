...
{
    public partial class rptChiphidieutriCC : DevExpress.XtraReports.UI.XtraReport
    {
        private int s_stt = 0;
        private string sLaMA = string.Empty;
        public rptChiphidieutriCC()
        {
            InitializeComponent();
        }

        private void rptChiphidieutriCC_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
