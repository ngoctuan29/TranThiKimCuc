...
{
    public partial class view_DauSinhTon : DevExpress.XtraReports.UI.XtraReport
    {
        public view_DauSinhTon()
        {
            InitializeComponent();
        }

        private void view_DauSinhTon_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
