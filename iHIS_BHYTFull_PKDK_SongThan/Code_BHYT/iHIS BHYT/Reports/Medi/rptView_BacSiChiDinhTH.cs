...
{
    public partial class view_BacSiChiDinhTH : DevExpress.XtraReports.UI.XtraReport
    {
        public view_BacSiChiDinhTH()
        {
            InitializeComponent();
        }

        private void view_BacSiChiDinhTH_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
