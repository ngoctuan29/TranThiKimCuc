...
{
    public partial class rptChidinhDichVu_A4 : DevExpress.XtraReports.UI.XtraReport
    {
        private int iSTT = 0;
        public rptChidinhDichVu_A4()
        {
            InitializeComponent();
        }

        private void rptChidinhDichVu_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
