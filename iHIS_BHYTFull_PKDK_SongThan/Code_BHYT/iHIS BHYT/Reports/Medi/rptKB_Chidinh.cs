...
{
    public partial class rptKB_Chidinh : DevExpress.XtraReports.UI.XtraReport
    {
        private int iSTT = 0;
        public rptKB_Chidinh()
        {
            InitializeComponent();
        }

        private void rptKB_Chidinh_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
