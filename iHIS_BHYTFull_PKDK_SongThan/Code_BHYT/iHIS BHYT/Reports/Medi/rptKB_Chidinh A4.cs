...
{
    public partial class rptChidinh_A4 : DevExpress.XtraReports.UI.XtraReport
    {
        private int iSTT = 0;
        public rptChidinh_A4()
        {
            InitializeComponent();
        }

        private void rptChidinh_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
