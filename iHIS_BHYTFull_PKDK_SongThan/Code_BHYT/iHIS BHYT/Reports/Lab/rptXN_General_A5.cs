...
{
    public partial class rptXN_General_A5 : DevExpress.XtraReports.UI.XtraReport
    {
        private DateTime dtWorking = new DateTime();
        public rptXN_General_A5(DateTime _dtWorking)
        {
            InitializeComponent();
            this.dtWorking = _dtWorking;
        }

        private void rptXN_General_A5_TTBVSKMTr_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
