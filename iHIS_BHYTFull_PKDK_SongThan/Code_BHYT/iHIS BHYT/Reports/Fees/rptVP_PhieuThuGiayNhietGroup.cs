...
{
    public partial class rptVP_PhieuThuGiayNhietGroup : DevExpress.XtraReports.UI.XtraReport
    {
        int stt = 1;
        public rptVP_PhieuThuGiayNhietGroup()
        {
            InitializeComponent();
        }

        private void rptVP_PhieuThuGiayNhietGroup_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
