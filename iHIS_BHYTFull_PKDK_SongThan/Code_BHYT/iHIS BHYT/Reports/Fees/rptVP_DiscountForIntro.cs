...
{
    public partial class rpt_VP_DiscountForIntro : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_VP_DiscountForIntro()
        {
            InitializeComponent();
        }

        private void rpt_VP_DiscountForIntro_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
