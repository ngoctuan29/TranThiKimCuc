...
{
    public partial class rpt_VP_ThongKeDoanhThuNgay : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_VP_ThongKeDoanhThuNgay()
        {
            InitializeComponent();
        }

        private void rpt_VP_ThongKeDoanhThuNgay_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
