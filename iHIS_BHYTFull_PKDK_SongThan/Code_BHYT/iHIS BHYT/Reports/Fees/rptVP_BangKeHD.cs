...
{
    public partial class rpt_VP_BangKeHD : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_VP_BangKeHD()
        {
            InitializeComponent();
        }

        private void rpt_VP_BangKeHD_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
