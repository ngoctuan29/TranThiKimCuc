...
{
    public partial class rpt_VP_TKeDoanhThuCT : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_VP_TKeDoanhThuCT()
        {
            InitializeComponent();
        }

        private void rpt_VP_TKeDoanhThuCT_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
