...
{
    public partial class rpt_VP_ThongKeDoanhThuNgayDetail : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_VP_ThongKeDoanhThuNgayDetail()
        {
            InitializeComponent();
        }

        private void rpt_VP_ThongKeDoanhThuNgayDetail_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
