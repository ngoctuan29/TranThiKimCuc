...
{
    public partial class rpt_BM03_YTTN_HDKCB : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_BM03_YTTN_HDKCB()
        {
            InitializeComponent();
        }

        private void rpt_KB_SoKhamBenh_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
