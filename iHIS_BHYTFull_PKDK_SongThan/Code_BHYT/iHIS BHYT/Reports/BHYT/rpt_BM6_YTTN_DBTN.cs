...
{
    public partial class rpt_BM6_YTTN_DBTN : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_BM6_YTTN_DBTN()
        {
            InitializeComponent();
        }

        private void rpt_BM6_YTTN_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
