...
{
    public partial class rptCLS_XQuangRotate : DevExpress.XtraReports.UI.XtraReport
    {
        private DateTime dtWorking = new DateTime();
        public rptCLS_XQuangRotate(DateTime _dtWorking)
        {
            InitializeComponent();
            this.dtWorking = _dtWorking;
        }

        private void rptCLS_XQuangRotate_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
