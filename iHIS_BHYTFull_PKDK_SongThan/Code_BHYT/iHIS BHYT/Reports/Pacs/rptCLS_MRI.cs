...
{
    public partial class rptMRI : DevExpress.XtraReports.UI.XtraReport
    {
        public rptMRI()
        {
            InitializeComponent();
        ...
        private void rptMRI_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
