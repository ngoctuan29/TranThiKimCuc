...
{
    public partial class rptCLS_XQuangA5Rotate : DevExpress.XtraReports.UI.XtraReport
    {
        private DateTime dtWorking = new DateTime();
        public rptCLS_XQuangA5Rotate(DateTime _dtWorking)
        {
            InitializeComponent();
            this.dtWorking = _dtWorking;
        }

        private void rptCLS_XQuangA5Rotate_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
