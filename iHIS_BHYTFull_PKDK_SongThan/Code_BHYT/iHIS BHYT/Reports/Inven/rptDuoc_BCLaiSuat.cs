...
{
    public partial class rpt_Thuoc_BCLaiSuat : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_Thuoc_BCLaiSuat()
        {
            InitializeComponent();
        }

        private void rpt_Thuoc_BCLaiSuat_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
