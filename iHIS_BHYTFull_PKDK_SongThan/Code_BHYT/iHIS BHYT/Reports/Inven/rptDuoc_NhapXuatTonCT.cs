...
{
    public partial class rpt_NhapXuatTonCT : DevExpress.XtraReports.UI.XtraReport
    {
        
        public rpt_NhapXuatTonCT()
        {
            InitializeComponent();
        }

        private void rpt_NhapXuatTonCT_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
