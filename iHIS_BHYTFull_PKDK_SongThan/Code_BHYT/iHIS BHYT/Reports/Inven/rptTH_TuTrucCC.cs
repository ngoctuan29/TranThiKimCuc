...
{
    public partial class rptThuocTuTrucCC : DevExpress.XtraReports.UI.XtraReport
    {
        private int stt = 0;
        public rptThuocTuTrucCC()
        {
            InitializeComponent();
        }

        private void rptThuocTuTrucCC_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
