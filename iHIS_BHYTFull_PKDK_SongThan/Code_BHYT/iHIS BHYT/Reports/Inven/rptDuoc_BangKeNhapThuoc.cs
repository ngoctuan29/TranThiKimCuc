...
{
    public partial class rpt_TH_BangKeNhapThuoc : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_TH_BangKeNhapThuoc()
        {
            InitializeComponent();
        }

        private void rpt_TH_BangKeNhapThuoc_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
