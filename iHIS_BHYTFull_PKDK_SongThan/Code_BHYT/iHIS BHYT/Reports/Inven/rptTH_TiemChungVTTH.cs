...
{
    public partial class rptTiemChungVTTH : DevExpress.XtraReports.UI.XtraReport
    {
        public rptTiemChungVTTH()
        {
            InitializeComponent();
        }

        private void rptTiemChungVTTH_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
