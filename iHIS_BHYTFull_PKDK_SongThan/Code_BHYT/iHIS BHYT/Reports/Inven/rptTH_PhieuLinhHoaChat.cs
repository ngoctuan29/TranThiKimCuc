...
{
    public partial class rpt_Thuoc_PhieuLinhHoaChat : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_Thuoc_PhieuLinhHoaChat()
        {
            InitializeComponent();
        }
        ...
        private void rpt_Thuoc_TheKho_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                lbSoyt.Text = ssoyte;
                lbName.Text = names;
                txtPrint.Text = "Ngày " + DateTime.Now.Day.ToString() + " tháng " + DateTime.Now.Month.ToString() + " năm " + DateTime.Now.Year.ToString();
