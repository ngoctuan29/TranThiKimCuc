...
{
    public partial class rptToaThuocBanLe : DevExpress.XtraReports.UI.XtraReport
    {
        int stt = 0;
        public rptToaThuocBanLe()
        {
            InitializeComponent();
        }

        private void rptToaThuocBanLe_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                txtPrintDate.Text = "(Hóa đơn: Ngày " + DateTime.Now.Day.ToString() + " tháng " + DateTime.Now.Month.ToString() + " năm " + DateTime.Now.Year.ToString() + ")";
