...
{
    public partial class rptThuocTuTrucThuPhi : DevExpress.XtraReports.UI.XtraReport
    {
        int stt = 0;
        public rptThuocTuTrucThuPhi()
        {
            InitializeComponent();
        }

        private void rptThuocTuTrucThuPhi_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
