...
{
    public partial class rptToaThuocMuaNgoaiCC : DevExpress.XtraReports.UI.XtraReport
    {
        int stt = 0;
        public rptToaThuocMuaNgoaiCC()
        {
            InitializeComponent();
        }

        private void rptToaThuocMuaNgoaiCC_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
