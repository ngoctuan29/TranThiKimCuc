...
{
    public partial class rptKB_ChidinhDichVu : DevExpress.XtraReports.UI.XtraReport
    {
        private int iSTT = 0;
        public rptKB_ChidinhDichVu()
        {
            InitializeComponent();
        }

        private void rptKB_ChidinhDichVu_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
