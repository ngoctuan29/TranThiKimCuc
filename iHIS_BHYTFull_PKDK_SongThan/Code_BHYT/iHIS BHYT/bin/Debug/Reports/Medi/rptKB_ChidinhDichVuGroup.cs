...
{
    public partial class rptKB_ChidinhDichVuGroup : DevExpress.XtraReports.UI.XtraReport
    {
        private int iSTT = 0;
        private DateTime dtimeWorking = new DateTime();
        public rptKB_ChidinhDichVuGroup(DateTime _dtimeWorking)
        {
            InitializeComponent();
            this.dtimeWorking = _dtimeWorking;
        }

        private void rptKB_ChidinhDichVuGroup_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
