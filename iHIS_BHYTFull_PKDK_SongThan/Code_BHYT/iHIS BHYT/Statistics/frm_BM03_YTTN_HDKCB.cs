...
{
    public partial class frm_BM03_YTTN_HDKCB : Form
    {
        ...
        private void butRefesh_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                this.dtbResult = rpt_General_BLL.TableHDKCB(Convert.ToDateTime(this.controlDatetime.TN.ToString()), Convert.ToDateTime(this.controlDatetime.DN.ToString()));
                Starting.Close();
        ...
        private void butPrint_Click_1(object sender, EventArgs e)
        {
            ...
            if (frmPath.reloaded)
            {
                ...
                dsTemp.WriteXmlSchema(@"..\..\xml\View_HDKCB.xml");
                Reports.rpt_BM03_YTTN_HDKCB rpt = new Reports.rpt_BM03_YTTN_HDKCB();
                ...
                rpt.ExportOptions.Xls.SheetName = "HDKCB";
