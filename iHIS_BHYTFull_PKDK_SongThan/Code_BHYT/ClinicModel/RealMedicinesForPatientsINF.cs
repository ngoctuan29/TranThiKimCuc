...
{
    public class RealMedicinesForPatientsINF
    {
        ...
        public Int32 VoteRowID { get; set; }
    ...
    public class RealMedicinesForPatientsDetailINF
    {
        public decimal RowID { get; set; }
    ...
    public class RealMedicinesForPatients_ViewINF
    {
        public decimal RowID { get; set; }
        public decimal RealRowID { get; set; }
        public string ItemCode { get; set; }
